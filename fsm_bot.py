...
# Description : Simple registration system using FSM
...
async def command_start(message: Message, state: FSMContext) -> None:
    ...
    await message.answer(
        "Hello! Welcome to the Simple Registration System. Please enter your name to continue.",
...
async def process_department(message: Message, state: FSMContext) -> None:
    ...
    if message.text.casefold() == "software engineering":
        ...
        await message.reply(
            "Nice choice! What school did you study at?",
            reply_markup=ReplyKeyboardRemove(),
        )
    else:
